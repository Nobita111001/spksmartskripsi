...
<head>
    ...
    <title>Rekomendasi Varietas Kopi Robusta</title>
    <!-- Favicon-->
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
        <div class="container px-4 px-lg-5">
            <div class="d-inline">
                <img src="assets/img/logokopi.png" width="75" class="me-2">
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100">
                ...
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white-75 mb-5">Rekomendasi Varietas Kopi Robusta Menggunakan Metode Simple Multi Attribute Rating Technique (SMART)</p>
            ...
            <div class="row gx-4 gx-lg-5">
                <div class="col-lg-12 text-center">
                    <div class="mt-5">
                        ...
                        <h3 class="h4 mb-2">Pengurutan Peringkat Rekomendasi Varietas Kopi Robusta</h3>
    ...
    <footer class="bg-light py-5">
        <div class="container px-4 px-lg-5">
            <div class="small text-center text-muted">202410102003 Novita Anggita Rahman</div>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
