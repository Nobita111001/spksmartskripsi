	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 mt-3">
				<div class="d-flex">
					<img src="assets/img/logokopi.png" width="90">
					<h3 class="text-center ms-2">Sistem Pendukung Keputusan Rekomendasi Varietas Kopi Robusta Menggunakan Metode Simple Multi Attribute Rating Technique (SMART)</h3>
				</div>
			</div>
			<div class="col-sm-12 mt-3">
				<?php
				...
				?>
				<p class="fs-5" style="text-align: justify;">Berdasarkan hasil perhitungan Sistem Pendukung Keputusan dengan menggunakan metode SMART, didapatkan bahwa <span class="fw-bold">"<?= $data_rekom['nama_alternatif']; ?>"</span> adalah jenis Varietas Kopi Robusta yang paling direkomendasikan untuk anda.</p>
